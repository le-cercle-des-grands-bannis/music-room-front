...
class RequestHttp {
    ...
    public static post = <T>(url: string, body: Record<string, any>, options?: RequestInit, locale?: string): Promise<T> => {
    ...
    public static put = <T>(url: string, body: Record<string, any>, options?: RequestInit, locale?: string): Promise<T> => {
    ...
    public static patch = async <T>(url: string, body: Record<string, any>, options?: RequestInit, locale?: string): Promise<T> => {
